...
// <select> nativo — funciona em formulários com Server Actions (FormData) sem
// precisar de estado no cliente, ao contrário do Select do Radix.
  ...
  ({ className, children, ...props }, ref) => {
    return (
      <div className="relative">
        ...
        <ChevronDown className="pointer-events-none absolute right-3 top-1/2 h-4 w-4 -translate-y-1/2 text-cplp-grey" />
      </div>
    );
  },
);
