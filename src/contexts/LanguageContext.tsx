...
const translations = {
  pt: {
    ...
    // Academy — cursos
    'academy.courses.tag': 'Cursos',
    'academy.courses.title': 'Próximos cursos',
    'academy.courses.description': 'Programas com data marcada e inscrições abertas. Não encontra o que procura? Desenhamos um programa à medida da sua equipa.',
    'academy.courses.empty': 'Estamos a preparar os próximos cursos. Fale connosco para um programa à medida da sua equipa.',
    'academy.courses.view': 'Ver curso',
    'academy.courses.featured': 'Destaque',
    'academy.courses.startsOn': 'Início a',

    // Detalhe de curso
    'course.back': 'Voltar à Academy',
    'course.about': 'Sobre o curso',
    'course.highlights': 'O que vai aprender',
    'course.requirements': 'Pré-requisitos',
    'course.audience': 'Para quem é',
    'course.details': 'Ficha do curso',
    'course.format': 'Formato',
    'course.area': 'Área',
    'course.duration': 'Duração',
    'course.schedule': 'Calendário',
    'course.price': 'Investimento',
    'course.location': 'Local',
    'course.level': 'Nível',
    'course.language': 'Idioma',
    'course.start': 'Início',
    'course.seats': 'Vagas',
    'course.related': 'Outros cursos',

    // Formulário de inscrição
    'enroll.title': 'Inscrever-se neste curso',
    'enroll.description': 'Preencha os seus dados e a equipa da Academy entra em contacto com os próximos passos.',
    'enroll.external': 'Inscrever-se',
    'enroll.name': 'Nome Completo *',
    'enroll.namePlaceholder': 'O seu nome completo',
    'enroll.email': 'Email *',
    'enroll.emailPlaceholder': 'seu.email@exemplo.com',
    'enroll.phone': 'Telefone',
    'enroll.phonePlaceholder': '+351 000 000 000',
    'enroll.company': 'Empresa',
    'enroll.companyPlaceholder': 'Nome da empresa',
    'enroll.role': 'Função',
    'enroll.rolePlaceholder': 'Ex: Diretor de Operações',
    'enroll.message': 'Mensagem',
    'enroll.messagePlaceholder': 'Objetivos, número de participantes, dúvidas...',
    'enroll.submit': 'Enviar Inscrição',
    'enroll.submitting': 'A enviar...',
    'enroll.successTitle': 'Inscrição enviada!',
    'enroll.successDescription': 'Recebemos o seu pedido. A equipa da Academy entra em contacto em breve.',
    'enroll.consentSuffix': 'e autorizo o tratamento dos meus dados para efeitos de contacto sobre esta formação.',

    // Carreiras — vagas
    'careers.openings.tag': 'Vagas',
    'careers.openings.title': 'Posições abertas',
    'careers.openings.empty': 'Não há vagas abertas neste momento. Envie-nos uma candidatura espontânea — guardamos o seu perfil.',
    'careers.openings.view': 'Ver vaga',
    'careers.openings.deadline': 'Candidaturas até',

    // Detalhe de vaga
    'job.back': 'Voltar às carreiras',
    'job.about': 'Sobre a vaga',
    'job.responsibilities': 'Responsabilidades',
    'job.requirements': 'Requisitos',
    'job.benefits': 'O que oferecemos',
    'job.details': 'Detalhes',
    'job.department': 'Departamento',
    'job.location': 'Local',
    'job.type': 'Contrato',
    'job.mode': 'Regime',
    'job.seniority': 'Senioridade',
    'job.apply.title': 'Candidatar-se a esta vaga',
    'job.apply.description': 'Envie o seu perfil. Analisamos todas as candidaturas e respondemos a todas.',
  ...
  en: {
    ...
    // Academy — cursos
    'academy.courses.tag': 'Courses',
    'academy.courses.title': 'Upcoming courses',
    'academy.courses.description': 'Programmes with confirmed dates and open registration. Can\'t find what you need? We design a programme tailored to your team.',
    'academy.courses.empty': 'We are preparing the next courses. Talk to us about a programme tailored to your team.',
    'academy.courses.view': 'View course',
    'academy.courses.featured': 'Featured',
    'academy.courses.startsOn': 'Starts on',
    ...
    'course.seats': 'Seats',
    'course.related': 'Other courses',

    // Formulário de inscrição
    'enroll.title': 'Register for this course',
    'enroll.description': 'Fill in your details and the Academy team will contact you with the next steps.',
    'enroll.external': 'Register',
    'enroll.name': 'Full Name *',
    'enroll.namePlaceholder': 'Your full name',
    'enroll.email': 'Email *',
    'enroll.emailPlaceholder': 'your.email@example.com',
    'enroll.phone': 'Phone',
    'enroll.phonePlaceholder': '+351 000 000 000',
    'enroll.company': 'Company',
    'enroll.companyPlaceholder': 'Company name',
    'enroll.role': 'Role',
    'enroll.rolePlaceholder': 'E.g. Head of Operations',
    'enroll.message': 'Message',
    'enroll.messagePlaceholder': 'Goals, number of participants, questions...',
    'enroll.submit': 'Send Registration',
    'enroll.submitting': 'Sending...',
    'enroll.successTitle': 'Registration sent!',
    'enroll.successDescription': 'We received your request. The Academy team will contact you shortly.',
    'enroll.consentSuffix': 'and consent to my data being used to contact me about this training.',

    // Carreiras — vagas
    'careers.openings.tag': 'Open roles',
    'careers.openings.title': 'Open positions',
    'careers.openings.empty': 'There are no open roles right now. Send us a spontaneous application — we\'ll keep your profile on file.',
    'careers.openings.view': 'View role',
    'careers.openings.deadline': 'Applications until',

    // Detalhe de vaga
    'job.back': 'Back to careers',
    'job.about': 'About the role',
    ...
    'job.apply.title': 'Apply for this role',
    'job.apply.description': 'Send us your profile. We review every application and reply to all of them.',
